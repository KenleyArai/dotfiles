...
startupWorkspace = "0:Main"  -- which workspace do you want to be on after launch?
...
-- The GIMP layout uses the ThreeColMid layout. The traditional GIMPi
...
myNewKeys =
    [
      ((0,0xffc7), spawn "amixer -D pulse sset Master toggle")
     ,((0,0xffc8), spawn "amixer -D pulse sset Master 4%-")
     ,((0,0xffc9), spawn "amixer -D pulse sset Master 4%+")
     ,((0,0x0ffbe), spawn "brightness_change -")
     ,((0,0x0ffbf), spawn "brightness_change +")
    ]

myKeyBindings = myNewKeys ++ 
  [
...
myManagementHooks = [
  ...
  , (className =? "Firefox") --> doF (W.shift "1:Browser")
